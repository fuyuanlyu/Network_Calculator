...
class NIN(object):
	def __init__(self, input_k, input_channel):
		...
		self.conv1 = layer.ConvLayer('conv1', input_k=self.input_k, input_channel=self.input_channel,\
									kernel=5, output_channel=192, padding=2)
	...
	def write_csv(self,filename="nin.csv"):
		with open(filename,'w') as csvFile:
			...
			for i, l in enumerate(self.all_layer):
				...
				temp.append("{}x{}x{}x{}".format(l.kernel[0], l.kernel[1], \
												l.input_channel, l.output_channel))
